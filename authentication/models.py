...
class UserProfile(models.Model):
    ...
    GOAL_CHOICES = [
        ...
        ('weight_fat_loss', 'Weight/fat loss'),
    ]
    
    primary_goal = models.CharField(max_length=30, choices=GOAL_CHOICES, blank=True, null=True)
    health_goals = JSONField(default=list, blank=True)  # Store multiple goals as array
    custom_goals = JSONField(default=list, blank=True)
    ...
    # Medical information
    medical_conditions = JSONField(default=list, blank=True)
    health_concerns = JSONField(default=list, blank=True)
    ...
    work_hours = models.CharField(max_length=10, blank=True, help_text="e.g., 8-10 hours")
    travel_frequency = models.CharField(max_length=10, blank=True, help_text="e.g., 1-2 times per month")
    
    # Sleep and wellness metrics
    sleep_hours = models.IntegerField(blank=True, null=True, help_text="Average sleep hours per night")
    energy_level = models.IntegerField(blank=True, null=True, help_text="Energy level (0-100)")
    sleep_quality = models.IntegerField(blank=True, null=True, help_text="Sleep quality (0-100)")
    
    # Wearables and tracking
    wearables = JSONField(default=list, blank=True)
    ...
    intake_completed_at = models.DateTimeField(blank=True, null=True)
    
    created_at = models.DateTimeField(default=timezone.now)
    updated_at = models.DateTimeField(auto_now=True)
    
    # Add age as a text field for manual entry
    age = models.CharField(max_length=3, blank=True, null=True, help_text="Age in years")
